...
public class TeleporterVoid extends Teleporter
{
	...
	public TeleporterVoid(WorldServer world)
	{
		super(world);
		this.worldObj = world;
	...
	public void placeInPortal(Entity entity, double posX, double posY, double posZ, float rotationYaw)
	{
		...
		if (entity instanceof EntityPlayerMP)
		{
			...
			if (player.dimension == Config.dimensionTheVoid && player.getBedLocation(player.dimension) == null)
			{
	...
	public boolean placeInExistingPortal(Entity entity, double posX, double posY, double posZ, float rotationYaw)
	{
		...
		else
		{
			for (int var2 = x - 128; var2 <= x + 128; ++var2)
			{
				...
				for (int var3 = z - 128; var3 <= z + 128; ++var3)
				{
					...
					{
						if (worldObj.getBlock(var2, y, var3) == TheVoid.void_portal)
						{
							while (worldObj.getBlock(var2, y - 1, var3) == TheVoid.void_portal)
							{
								--y;
							}
		...
		if (var1 >= 0.0D)
		{
			...
			if (worldObj.getBlock(blockX - 1, blockY, blockZ) == TheVoid.void_portal)
			{
				var5 = 2;
			}
			...
			if (worldObj.getBlock(blockX, blockY, blockZ - 1) == TheVoid.void_portal)
			{
				var5 = 3;
			}
	...
	public boolean makePortal(Entity entity)
	{
			...
			for (var6 = -1; var6 <= 1; ++var6)
			{
				for (var7 = 1; var7 < 3; ++var7)
				{
					for (var8 = -1; var8 < 3; ++var8)
					{
						...
						worldObj.setBlock(var10, var9, var12, flag ? Blocks.end_stone : Blocks.air);
					}
				}
			}
		}
		...
		for (var6 = 0; var6 < 4; ++var6)
		{
			for (var7 = -1; var7 < 4; ++var7)
			{
				...
				worldObj.setBlock(var10, var9, var12, flag ? Blocks.end_stone : TheVoid.void_portal, 0, 2);
			}
		}
